<template>
  <div class="flex items-center">
    ...
    <button class="bg-gradient-to-r from-rose-500 to-rose-600 text-white lg:px-5 lg:py-2.5 px-4 py-2 flex justify-center items-center shadow-default shadow-rose-300">
